...
export default function OutreachModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden border border-gray-100 relative max-h-[90vh] flex flex-col">
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-bold text-gray-900 leading-tight">Outreach & Email Finder</h2>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="space-y-2">
            ...
            {loading ? (
              ...
              <div className="p-4 rounded-xl border border-dashed border-gray-200 bg-gray-50 text-center text-xs text-gray-500">
                ...
                {contacts.map((contact) => (
                  ...
                  >
                    <div className="min-w-0 pr-2">
                      ...
                      <div className="text-[10px] text-gray-400">Source: {contact.source}</div>
                    </div>
          ...
          <div className="space-y-3 pt-2 border-t border-gray-100">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">Email Message Body</label>
              <textarea
                rows={6}
                value={body}
                onChange={(e) => setBody(e.target.value)}
                className="w-full p-3 text-xs text-gray-800 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono leading-relaxed"
              />
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-100 flex items-center justify-between bg-gray-50">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-300 text-white text-xs font-semibold rounded-xl transition shadow-sm flex items-center gap-1.5"
            >
